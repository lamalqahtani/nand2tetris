...
public class Assembler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileReader reader1 = new FileReader(new File("Input2.asm"));
            // String fileName = file.getName().substring(0, file.getName().length() - 4) + ".hack";
            FileWriter writer = new FileWriter(new File("Output.hack"));
    ...
    public void scanTokens() {
        ...
        if (isFirstPass) {
            ...
            if(c != '@' && c!='('){
                ...
                //the start should be updated before every iteration. (I updated the start before the condition because the first character was already read which is the initial value of tmp)
    ...
    public void parseTokens(){
        ...
        for(Instruction inst : tokens){
            if(inst instanceof AInstruction){
                ...
                String comp = (cInst.comp != null ? cInstructionTableComp.get(cInst.comp) : "1101010");
